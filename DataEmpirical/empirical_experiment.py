...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--prefix', required=False, type=str, default="", dest="prefix")
    parser.add_argument('-n', '--name', required=True, type=str, default="Primates", dest="name")
    parser.add_argument('--cds', required=True, type=str, default="CDS.ali", dest="cds")
    parser.add_argument('--tree', required=True, type=str, default="rootedtree.nhx", dest="tree")
